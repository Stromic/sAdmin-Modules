...
slib.setLang("sadmin", "en", "forcemurderer_help", "This will force the targetted players role to be the murderer next round.")
slib.setLang("sadmin", "en", "tospec_help", "Force specified player to spectate.")
slib.setLang("sadmin", "en", "mapnr_help", "Set the map in the next round.")
